...
public class RentController {
    ...
    @ResponseBody
    public ServerResponse<Object> get_myRent_list(HttpServletRequest httpServletRequest,@RequestBody Map<String, Object> params){
    ...
    @ResponseBody
    public ServerResponse<String> operation_userment(HttpServletRequest httpServletRequest,@RequestBody Map<String, Object> params){
    ...
    @ResponseBody
    public ServerResponse<Object> getrentList(HttpServletRequest httpServletRequest,@RequestBody Map<String,Object> params){
