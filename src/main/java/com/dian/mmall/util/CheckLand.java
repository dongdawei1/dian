...
//             		return ServerResponse.createByErrorMessage(meiyouquanxString);}
//     		}//装修，灭虫广告菜谱查看权限	
		else if (menu.equals("/home/pestControl") || menu.equals("/home/menu") || menu.equals("/home/renovation")
				|| menu.equals("menuAndRenovationAndPestControl")) {
			...
			// 工服
			if (role != 1 && role != 2 && role != 3 && role != 4 && role != 5 && role != 7 && role != 11
					&& role != 12) {
				return ServerResponse.createByErrorMessage(meiyouquanxString);
			}
